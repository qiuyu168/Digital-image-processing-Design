...
ALGORITHM_META = {
    ...
    "name": "butterworth_high_pass",
    "display_name": "巴特沃斯高通滤波",
    "description": "使用巴特沃斯高通传递函数保留高频边缘细节。",
    "params": {
...
def run(image: np.ndarray, params: dict | None = None) -> dict:
    ...
    low_pass = 1.0 / (1.0 + (distance / max(cutoff, 1)) ** (2 * order))
    transfer = 1.0 - low_pass
    ...
    return {
        ...
        "analysis": "巴特沃斯高通滤波平滑地抑制低频背景并保留高频变化，可用于突出边缘和纹理。",
    }
