...
ALGORITHM_META = {
    ...
    "display_name": "高通滤波",
    "description": "保留高频信息，抑制低频信息，用于增强边缘和细节。",
    "params": {
        "radius": {
            "type": "int",
            "default": 30,
...
def run(image: np.ndarray, params: dict | None = None) -> dict:
    ...
    low_mask = np.exp(-(distance ** 2) / (2 * float(radius ** 2)))
    mask = 1.0 - low_mask
    ...
    return {
        ...
        "analysis": "高通滤波抑制中心低频成分并保留远离中心的高频信息，因此输出会突出边缘、纹理和灰度突变区域。",
    }
