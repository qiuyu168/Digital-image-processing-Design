# Kimi Prompt: Improve One Backend Image Processing Algorithm With Frontend Slider Parameters

## Model-Specific Instruction

You are Kimi acting as a long-context project consistency assistant.
Keep the implementation consistent with the README, algorithm module list, manual testing script, current directory naming, and frontend dynamic parameter panel rules.
